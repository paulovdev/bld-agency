...
const CollabBlock = ({
  ...
  return (
    ...
    >
      ...
      <div className="px-10 w-[50vw] h-full bg-bg-2  flex flex-col justify-center max-lg:pl-3">
        ...
        <h3 className="mt-2 text-[1rem] text-s uppercase tracking-[1px] font-semibold max-md:text-[.8rem]">
          {subTitle}
        </h3>

        <p className="my-8 text-[.85rem] text-s/75 max-w-[500px] leading-tight">
          {description}
        </p>

        <button
          className="w-fit px-8 h-[42px] rounded-full bg-bg flex items-center justify-center border border-brd-2 group hover:bg-bg-2 duration-300 transition-colors 
        max-lg:h-[32px]"
        >
          <span className="text-p text-[.8rem] tracking-wide max-lg:text-[.75rem] group-hover:text-s transition-all duration-300">
            {cta}
          </span>
        </button>
      </div>
